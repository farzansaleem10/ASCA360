...
const AlumniRegister = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setMessage(
        result.message ||
          (response.ok ? "Registration successful!" : "An error occurred.")
      );
    } catch (error) {
        ...
        <form onSubmit={handleSubmit} className="alumni-form">
              ...
              <div className="form-row">
                <div className="form-group">
                  ...
                  <input
                    type="text"
                    name="institution"
                    value={formData.currentWorkplace.institution}
                ...
                <div className="form-group">
                  ...
                  <input
                    type="text"
                    name="designation"
                    value={formData.currentWorkplace.designation}
                    onChange={handleCurrentWorkplaceChange}
                  />
                </div>
              </div>
          ...
          <div className="form-section">
            ...
            <div className="form-group certificate-upload">
              ...
              />
              <small>
                Please upload your degree certificate. PDF or image formats are
                accepted.
              </small>
            </div>
          </div>
