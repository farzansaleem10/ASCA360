...
import { BookCopy, Layers3, Code, GraduationCap, ArrowUpRight } from 'lucide-react';
import './Academics.css'; // Using the new stylesheet

// The data remains the same, but with new icons for a consistent theme
...
const Academics = () => {
    ...
    // The JSX is updated for the new design but the mapping logic is identical
    return (
