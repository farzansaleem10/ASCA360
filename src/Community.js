      ...
      <div className="modal-content" onClick={(e) => e.stopPropagation()}>
        ...
        <div className="modal-header">
          <img
            ...
            onError={(e) => {
              e.target.src =
                "https://placehold.co/150x150/1C1C1C/A1A1AA?text=No+Image";
            }}
          />
        </div>
        <div className="modal-body">
          ...
          <p className="modal-subtitle">
            MCA Graduate - {alumni.graduationYear}
          </p>

          {alumni.currentWorkplace && alumni.currentWorkplace.institution && (
            <div className="work-info">
              <p>
                {alumni.currentWorkplace.designation} at{" "}
                <strong>{alumni.currentWorkplace.institution}</strong>
              </p>
            </div>
          )}
